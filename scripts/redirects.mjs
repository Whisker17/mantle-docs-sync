/**
 * Redirect rules extracted from next.config.mjs.
 *
 * In dev/SSR mode these are served via Next.js `redirects()`.
 * In static-export mode (GitHub Pages) a post-build script turns them into
 * HTML files with <meta http-equiv="refresh">.
 */
