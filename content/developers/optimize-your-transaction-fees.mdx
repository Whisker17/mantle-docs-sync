...
If you are a user of MetaMask for trading or contract deployment and interaction (e.g. using [Remix](/developers/how-to-guides/how-to-deploy-smart-contracts/use-remix-to-deploy-smart-contracts)), you can set up `basefee` and `priorityfee` in MetaMask to be able to send transactions at a lowest fee. Details can be found [here](/users/how-to-guides/connecting-wallet-to-mantle-network#configure-your-wallet).

## Hardhat 

If you are using [Hardhat](/developers/how-to-guides/how-to-deploy-smart-contracts/use-hardhat-to-deploy-smart-contracts) for contract deployment and interaction, you can use the default configuration in `hardhat.config.ts` or specify `gasPrice` as the network minimum basefee:
...
If you are using [Foundry](/developers/how-to-guides/how-to-deploy-smart-contracts/use-foundry-to-deploy-smart-contracts) for contract deployment and interaction, you need to set it up on the corresponding command line:
