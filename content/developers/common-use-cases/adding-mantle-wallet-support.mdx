...
1. Official rate-limited [public endpoint](/developers/quick-access#network-details).
2. Third-party endpoints from infrastructure [providers](/developers/node-endpoints-and-providers).
3. Running your [own node](/node-operators/tutorials).
...
Mantle network aims to be EVM-compatible, you can see a summary of the few differences between Mantle and Ethereum [here](/mantle-network/fee-mechanism).
