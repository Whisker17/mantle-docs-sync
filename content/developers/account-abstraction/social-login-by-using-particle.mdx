...
Particle Network is compatible with Mantle Mainnet and Testnet, supporting EOA interactions and native ERC-4337 via implementations like SimpleAccount and Cyber Connect.
