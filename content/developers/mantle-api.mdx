...
We've also introduced custom methods to simplify certain Mantle-specific interactions. All methods can be accessed via `https` and `websocket`, endpoints can be found [here](/developers/node-endpoints-and-providers).
