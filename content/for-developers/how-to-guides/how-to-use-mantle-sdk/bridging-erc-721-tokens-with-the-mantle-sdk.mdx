---
title: "Bridging ERC-721 tokens with the Mantle SDK"
---
...
This tutorial teaches you how to use the Mantlenetwork SDK to transfer ERC-721 token between layer 1 (L1) and layer 2 (L2). While you *could* use [the bridge contracts](https://github.com/mantlenetworkio/mantle-v2/blob/5f86db304a9dff61510297223fa27317130d3c5d/packages/contracts-bedrock/contracts/L1/L1ERC721Bridge.sol#L4) directly
