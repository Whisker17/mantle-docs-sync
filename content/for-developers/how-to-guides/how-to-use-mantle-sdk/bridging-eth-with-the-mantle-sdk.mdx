---
title: "Bridging ETH with the Mantle SDK"
---
...
## Setup[​](https://docs-v2.mantle.xyz/devs/dev-guides/how-to/bridge-eth#setup) <a href="#setup" id="setup"></a>
...
## Run the Sample Code[​](https://docs-v2.mantle.xyz/devs/dev-guides/how-to/bridge-eth#run-the-sample-code) <a href="#run-the-sample-code" id="run-the-sample-code"></a>

The sample code is in `index.js`, the whole execution flow will automatically start after running it.

### Node Environment[​](https://docs-v2.mantle.xyz/devs/dev-guides/how-to/bridge-eth#node-environment) <a href="#node-environment" id="node-environment"></a>
...
## How Does It Work?[​](https://docs-v2.mantle.xyz/devs/dev-guides/how-to/bridge-eth#how-does-it-work) <a href="#how-does-it-work" id="how-does-it-work"></a>

### Import the Necessary Libraries[​](https://docs-v2.mantle.xyz/devs/dev-guides/how-to/bridge-eth#import-the-necessary-libraries) <a href="#import-the-necessary-libraries" id="import-the-necessary-libraries"></a>
...
### Network Configuration and Wallet Setup[​](https://docs-v2.mantle.xyz/devs/dev-guides/how-to/bridge-eth#network-configuration-and-wallet-setup) <a href="#network-configuration-and-wallet-setup" id="network-configuration-and-wallet-setup"></a>
...
### Setup CrossChainMessenger Object[​](https://docs-v2.mantle.xyz/devs/dev-guides/how-to/bridge-eth#setup-crosschainmessenger-object) <a href="#setup-crosschainmessenger-object" id="setup-crosschainmessenger-object"></a>
...
### Report the Balances[​](https://docs-v2.mantle.xyz/devs/dev-guides/how-to/bridge-eth#report-the-balances) <a href="#report-the-balances" id="report-the-balances"></a>
...
### Deposit[​](https://docs-v2.mantle.xyz/devs/dev-guides/how-to/bridge-eth#deposit) <a href="#deposit" id="deposit"></a>
...
### Withdraw[​](https://docs-v2.mantle.xyz/devs/dev-guides/how-to/bridge-eth#withdraw) <a href="#withdraw" id="withdraw"></a>
...
### Invoke deposit and withdraw functions <a href="#main" id="main"></a>
...
## Conclusion[​](https://docs-v2.mantle.xyz/devs/dev-guides/how-to/bridge-eth#conclusion) <a href="#conclusion" id="conclusion"></a>
