...
### Prerequisite[​](https://docs-v2.mantle.xyz/devs/dev-guides/how-to/deploy/foundry#prerequisite) <a href="#prerequisite" id="prerequisite"></a>
...
## Install Foundry[​](https://docs-v2.mantle.xyz/devs/dev-guides/how-to/deploy/foundry#install-foundry) <a href="#install-foundry" id="install-foundry"></a>
...
## Create a project[​](https://docs-v2.mantle.xyz/devs/dev-guides/how-to/deploy/foundry#create-a-project) <a href="#create-a-project" id="create-a-project"></a>
...
## Deploy your contract[​](https://docs-v2.mantle.xyz/devs/dev-guides/how-to/deploy/foundry#deploy-your-contract) <a href="#deploy-your-contract" id="deploy-your-contract"></a>
