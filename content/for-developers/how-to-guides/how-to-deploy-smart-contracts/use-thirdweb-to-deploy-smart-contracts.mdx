...
## Prerequisite[​](https://docs-v2.mantle.xyz/devs/dev-guides/how-to/deploy/thirdweb#prerequisite) <a href="#prerequisite" id="prerequisite"></a>
...
## Install Thirdweb CLI[​](https://docs-v2.mantle.xyz/devs/dev-guides/how-to/deploy/thirdweb#install-thirdweb-cli) <a href="#install-thirdweb-cli" id="install-thirdweb-cli"></a>
...
## Create a project[​](https://docs-v2.mantle.xyz/devs/dev-guides/how-to/deploy/thirdweb#create-a-project) <a href="#create-a-project" id="create-a-project"></a>
...
## Deploy your contract[​](https://docs-v2.mantle.xyz/devs/dev-guides/how-to/deploy/thirdweb#deploy-your-contract) <a href="#deploy-your-contract" id="deploy-your-contract"></a>
