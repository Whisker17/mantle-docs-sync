...
## Prerequisite[​](https://docs-v2.mantle.xyz/devs/dev-guides/how-to/deploy/hardhat#prerequisite) <a href="#prerequisite" id="prerequisite"></a>
...
## Create a project and configure[​](https://docs-v2.mantle.xyz/devs/dev-guides/how-to/deploy/hardhat#create-a-project-and-configure) <a href="#create-a-project-and-configure" id="create-a-project-and-configure"></a>
...
## Compile and Deploy[​](https://docs-v2.mantle.xyz/devs/dev-guides/how-to/deploy/hardhat#compile-and-deploy) <a href="#compile-and-deploy" id="compile-and-deploy"></a>


> **Info**

If you need to verify your contracts, we strongly recommend that you skip directly to the [‘Use Hardhat to Verify Smart Contracts’](/for-developers/how-to-guides/how-to-verify-smart-contracts/use-hardhat-to-verify-smart-contracts) section to avoid double deploying contracts when verifying them!
