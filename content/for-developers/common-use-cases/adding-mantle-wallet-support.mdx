...
## Connecting to Mantle[​](https://docs-v2.mantle.xyz/devs/dev-guides/common/wallet#connecting-to-mantle) <a href="#connecting-to-mantle" id="connecting-to-mantle"></a>
...
### Add Mantle Network to Metamask Quickly[​](https://docs-v2.mantle.xyz/devs/dev-guides/common/wallet#add-mantle-network-to-metamask-quickly) <a href="#add-mantle-network-to-metamask-quickly" id="add-mantle-network-to-metamask-quickly"></a>
...
## Canonical Token Addresses[​](https://docs-v2.mantle.xyz/devs/dev-guides/common/wallet#canonical-token-addresses) <a href="#canonical-token-addresses" id="canonical-token-addresses"></a>
...
## Transaction Status[​](https://docs-v2.mantle.xyz/devs/dev-guides/common/wallet#transaction-status) <a href="#transaction-status" id="transaction-status"></a>
...
## Transaction Fees[​](https://docs-v2.mantle.xyz/devs/dev-guides/common/wallet#transaction-fees) <a href="#transaction-fees" id="transaction-fees"></a>
...
## Estimating Total Fees[​](https://docs-v2.mantle.xyz/devs/dev-guides/common/wallet#estimating-total-fees) <a href="#estimating-total-fees" id="estimating-total-fees"></a>
...
## Sending "Max" $MNT[​](https://docs-v2.mantle.xyz/devs/dev-guides/common/wallet#sending-max-mnt) <a href="#sending-max-mnt" id="sending-max-mnt"></a>
