...
#### Change Log <a href="#mantle-v2" id="mantle-v2"></a>

**All**

[​](https://docs-v2.mantle.xyz/nodes/changelogs/v1.0.2#mantle-v2)Activate 8 OP Stack forks (Canyon, Delta, Ecotone, Fjord, Granite, Holocene, Isthmus, Jovian) simultaneously at the Arsia timestamp via `AlignOpWithMantle()`.
