...
Different transaction types, such as Legacy and EIP-1559 transactions, require distinct handling. For detailed information, please refer to [this](/mantle-network/fee-mechanism/..#l2-gasprice-depends-on-the-transaction-type).
...
If you want to learn more, please refer to [this](/mantle-network/fee-mechanism/..#rollupdatagascalculation).
