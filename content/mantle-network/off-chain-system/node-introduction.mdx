...
* Fetch data from the sequencer and process it (encoding and compressing) into frames based on different configurations, storing the frames as a [channel](/mantle-network/glossary#channel)
