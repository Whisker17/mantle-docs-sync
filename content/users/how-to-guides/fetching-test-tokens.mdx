...
<Callout type="info">
Make sure to import the `$MNT` token to your Sepolia wallet to see the current balance. The contract address is `0x65e37B558F64E2Be5768DB46DF22F93d85741A9E`. How to import tokens can be found [here](/users/how-to-guides/connecting-wallet-to-mantle-network#add-mnt-to-your-wallet).
</Callout>
...
Next, switch your wallet network to Sepolia, and [import](/users/how-to-guides/connecting-wallet-to-mantle-network#add-mnt-to-your-wallet) (if you haven't already) the `$MNT` token.
...
<img src="https://docs-v2.mantle.xyz/assets/images/faucet-4-b426051a807fa7c86c020634b043434f.png" alt="" />
...
<img src="https://docs-v2.mantle.xyz/assets/images/faucet-2-97cba3a14570abc851f81c0068f6e8a3.png" alt="" />
...
<img src="https://docs-v2.mantle.xyz/assets/images/faucet-3-0f50cf2719283b5f35828a73be4738f3.png" alt="" />
